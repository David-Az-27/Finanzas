...
interface ResumenPagosChartProps {
  data: PresupuestoData[];
  isLoading: boolean;
}

export function ResumenPagosChart({ data, isLoading }: ResumenPagosChartProps) {
    ...
    >
      <Card className="bg-white/5 backdrop-blur-2xl shadow-xl rounded-2xl p-4 shadow-lg border border-white/10 h-full flex flex-col">
        <CardHeader className="p-0 pb-2">
          <CardTitle className="text-white font-semibold text-sm">Resumen de Pagos</CardTitle>
        </CardHeader>
